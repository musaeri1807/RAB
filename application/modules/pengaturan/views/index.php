                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group <?php if (form_error('smtp_password')) echo 'has-error' ?>">
                                                ...
                                                <input type="password" id="smtp_password" name="smtp_password" class="form-control smtp_password " placeholder="SMTP Password" value="<?php echo $pengaturan['smtp_password'] ?>">
