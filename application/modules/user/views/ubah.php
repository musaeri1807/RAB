                       ...
                       <form method="POST" enctype="multipart/form-data">
                        <div class="form-group <?php if(form_error('id_user')) echo 'has-error'?>">
                          ...
                          <?php echo form_error('id_user', '<small style="color:red">','</small>') ?>
                           ...
                           <div class="form-group <?php if(form_error('id_jabatan')) echo 'has-error'?>">
                               <label for="id_jabatan">Jabatan</label>
                               <select name="id_jabatan" id="id_jabatan" class="form-control">
                                   <option value="">-- Silahkan Pilih Jabatan ---</option>
                                   <?php foreach ($jabatan as $row): ?>
                                       <option value="<?php echo $row['id_jabatan'] ?>" <?php echo $user['id_jabatan'] == $row['id_jabatan'] ? 'selected' : '' ?>><?php echo $row['nama_jabatan'] ?></option>
                                   <?php endforeach ?>
                               </select>
                               <?php echo form_error('id_jabatan', '<small style="color:red">','</small>') ?>
                           </div>
                           <div class="form-group">
