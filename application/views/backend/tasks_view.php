                                        ...
                                        <tbody>
                                           <?php foreach($prolist as $value): ?>
                                            <tr>
                                                ...
                                                <td><?php echo substr($value->item,0,25).'...' ?></td>
                                                <td><?php echo "12";  ?></td>
                                                <td><?php echo "1233333" ?></td>
                                                <td>
                                             
                                                <img src="<?php echo base_url(); ?>assets/images/users/<?php echo $value->em_image ?>" height="40px" width="40px" style="border-radius:50px" alt="" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $value->first_name; ?>">
                                                
                                                </td>
                                                <td><?php echo $value->status_list; ?></td>
